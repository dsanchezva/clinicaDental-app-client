...
const navigation = [
  ...
  { name: 'Tratamientos', href: '/treatments', current: false },
...
function Navbar() {
    ...
    useEffect(() => {
        if (isLoggedIn) {
            navigation.push({ name: 'Administrador',href: '/admin', current: false }) 
        }
    },[]);
  return (
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-blue-600 text-white' : 'text-slate-50 hover:bg-gray-700 hover:text-white',
